...
public abstract class roomsForManager extends basicRoomDetails {
    ...
    public void EnterRoomFees(){
        ...
        System.out.println("Breakfast:"); this.foodBoardPrice[0]=helpingMethods.checkFeesInput();
        System.out.println("Lunch:");     this.foodBoardPrice[1]=helpingMethods.checkFeesInput();
        System.out.println("Dinner:");    this.foodBoardPrice[2]=helpingMethods.checkFeesInput();
    }
