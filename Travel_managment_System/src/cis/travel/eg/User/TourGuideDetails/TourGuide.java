...
*/
    ...
    public int update_TravelHistory() {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                if (!history_Trips)
                    System.out.println(Main.ANSI_COLORS[11] + "History is empty." + Main.ANSI_COLORS[16]);
    ...
    public int ViewTrips_Complaints() {
        ...
        if (choice == 1) {
            ...
            if (!isCurrent)
                System.out.println(Main.ANSI_COLORS[11] + "You aren't currently in any trips!" + Main.ANSI_COLORS[16]);
            Main.sleep();
        }
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(salary, tourGuide.salary) == 0 && Double.compare(Salary_per_day, tourGuide.Salary_per_day) == 0 && Objects.equals(country, tourGuide.country) && Objects.equals(History_Current_trips, tourGuide.History_Current_trips) && Objects.equals(Complainttrips, tourGuide.Complainttrips) && Objects.equals(LanguageOptions, tourGuide.LanguageOptions) && Objects.equals(Languages, tourGuide.Languages);
    }

    @Override
    public int hashCode() {
        return Objects.hash(country, History_Current_trips, Complainttrips, LanguageOptions, Languages, salary, Salary_per_day);
    }
